...
class StatisticsSection extends StatefulWidget {
  ...
  @override
  StatisticsSectionState createState() => StatisticsSectionState();
}
            ...
            builder: (context, sizingInformation) {
              ...
              if (screenWidth < (const RefinedBreakpoints().tabletLarge)) {
                return Container(
                  ...
                  padding:
                      const EdgeInsets.symmetric(vertical: Sizes.padding40),
                  child: Column(
                ...
                return ClipRRect(
                  borderRadius: const BorderRadius.only(
                    ...
                    bottomRight: Radius.circular(Sizes.radius10),
                  ),
                  child: Stack(
                    children: [
                      Positioned(
