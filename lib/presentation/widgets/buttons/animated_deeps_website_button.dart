...
class AnimatedDeepsWebsiteButton extends StatefulWidget {
  final String title;
  ...
  const AnimatedDeepsWebsiteButton({
    super.key,
    required this.title,
    ...
    this.leadingButtonColor = AppColors.purple500,
    this.trailingButtonColor = AppColors.purple700,
  ...
  @override
  AnimatedDeepsWebsiteButtonState createState() =>
      AnimatedDeepsWebsiteButtonState();
}

class AnimatedDeepsWebsiteButtonState
    extends State<AnimatedDeepsWebsiteButton> {
